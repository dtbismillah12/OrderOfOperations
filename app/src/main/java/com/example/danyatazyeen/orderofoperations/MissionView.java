...
import com.example.danyatazyeen.orderofoperations.Barrier;
import com.example.danyatazyeen.orderofoperations.Blaster;
import com.example.danyatazyeen.orderofoperations.Obstacle;
import com.example.danyatazyeen.orderofoperations.Spaceship;
import com.example.danyatazyeen.orderofoperations.UFO;
...
public class MissionView extends SurfaceView implements Runnable{
    ...
    // Up to 60 invaders
    private UFO[] invaders = new UFO[60];
    ...
    private void prepareLevel(){
        ...
        for(int shelterNumber = 0; shelterNumber < 4; shelterNumber++){
            for(int column = 0; column < 10; column ++ ) {
                for (int row = 0; row < 5; row++) {
                    bricks[numBricks] = new Barrier(row, column, shelterNumber, screenX, screenY);
                    numBricks++;
                }
            }
        }
